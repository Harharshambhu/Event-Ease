...
import { DIETARY_AGGREGATE, LIVE_MEAL_SERVICE, VENDOR, OCCASIONS } from './data';
            ...
            <div className="cat-widget__row">
                ...
                <div>
                    <div className="cat-widget__card" style={{ marginBottom: 0 }}>
                        ...
                        {/* Dietary Breakdown + Service Style — two columns */}
                            ...
                            <div>
                                ...
                                <div style={{ marginTop: 12, padding: '8px 10px', background: '#fff8e1', borderRadius: 4, border: '1px solid #ffe082' }}>
                                    <div style={{ marginBottom: 4 }}>
                                        <span style={{ display: 'inline-block', padding: '2px 7px', background: '#F39C12', color: '#fff', fontSize: 10, fontWeight: 700, borderRadius: 4, letterSpacing: '0.2px' }}>△ Action Required</span>
                                    </div>
                        ...
                        {/* Live Meal Service — full-width row */}
                ...
                {/* ── RIGHT: 2 sub-widgets stacked + Vendor Status ── */}
                <div>

                    {/* Catering Setup */}
                    <div className="cat-widget__sub" style={{ marginBottom: 12 }} onClick={() => onNavigate('occasion-setup')}>
                    ...
                    {/* Final Count */}
                    <div className="cat-widget__sub" style={{ marginBottom: 12 }} onClick={() => onNavigate('count-lock')}>
                        <div className="cat-widget__sub-header">
                    ...
                    <div className="cat-widget__card" style={{ marginBottom: 0 }}>
                        ...
                        <div className="cat-widget__vendor-row">
                            <span>Invoice Received</span>
                            <span className="cat-widget__vendor-ok">✓ Yes</span>
                        </div>
                        <div className="cat-widget__vendor-row">
                            <span>Tax Docs</span>
                            <span className="cat-widget__vendor-ok">✓ Complete</span>
                        </div>
                        <div className="cat-widget__vendor-row">
                            <span>Payment</span>
                            <span style={{ fontSize: 11, fontWeight: 600, color: '#1A365D' }}>Processed</span>
                        </div>
                        <div className="cat-widget__vendor-row">
                            <span>Variance</span>
                            <span className="cat-widget__vendor-warn">+₹2,500</span>
                        </div>
                    </div>
